 ...
 * @notice A Escrow contract proofs that your contributed funds are locked through inviolable smart contracts
 */
contract Escrow is Ownable {
    ...
    function getEscrowByWithdrawer(address _withdrawer)
        external
        view
        returns (uint256[] memory)
    {
    ...
    function getEscrowById(uint256 _id) external view returns (Items memory) {
